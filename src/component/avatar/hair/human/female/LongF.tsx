...
const Long: React.FC<LooksColor>  = ({ color, secondColor }) => {
    return (
        <svg version="1.1" viewBox='0 0 41 41' className={styles.colores} fill="currentColor"  xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges">
            ...
            <rect x="23" y="0" width="1" height="1" fill={secondColor} />
            ...
            <rect x="23" y="1" width="1" height="1" fill={secondColor} />
            <rect x="24" y="1" width="1" height="1" fill={secondColor} />
            ...
            <rect x="7" y="5" width="1" height="1" fill={secondColor} />
            ...
            <rect x="3" y="15" width="1" height="1" fill={color} />
            ...
            <rect x="3" y="24" width="1" height="1" fill={color} />
            ...
            <rect x="28" y="27" width="1" height="1" fill={secondColor} />
            <rect x="4" y="28" width="1" height="1" fill={color} />
            <rect x="5" y="28" width="1" height="1" fill={color} />
            <rect x="6" y="28" width="1" height="1" fill={color} />
            <rect x="7" y="28" width="1" height="1" fill={secondColor} />
            <rect x="27" y="28" width="1" height="1" fill={secondColor} />
            <rect x="28" y="28" width="1" height="1" fill={secondColor} />
            <rect x="4" y="29" width="1" height="1" fill={color} />
            <rect x="5" y="29" width="1" height="1" fill={color} />
            <rect x="6" y="29" width="1" height="1" fill={color} />
            <rect x="7" y="29" width="1" height="1" fill={secondColor} />
            <rect x="27" y="29" width="1" height="1" fill={secondColor} />
            <rect x="28" y="29" width="1" height="1" fill={secondColor} />
            <rect x="4" y="30" width="1" height="1" fill={color} />
            <rect x="5" y="30" width="1" height="1" fill={color} />
            ...
            <rect x="27" y="30" width="1" height="1" fill={secondColor} />
            <rect x="28" y="30" width="1" height="1" fill={secondColor} />
            <rect x="4" y="31" width="1" height="1" fill={color} />
            <rect x="5" y="31" width="1" height="1" fill={color} />
            <rect x="6" y="31" width="1" height="1" fill={secondColor} />
            <rect x="7" y="31" width="1" height="1" fill={secondColor} />
            <rect x="8" y="31" width="1" height="1" fill={secondColor} />
            <rect x="9" y="31" width="1" height="1" fill={secondColor} />
            <rect x="27" y="31" width="1" height="1" fill={secondColor} />
            <rect x="5" y="32" width="1" height="1" fill={color} />
            <rect x="6" y="32" width="1" height="1" fill={secondColor} />
            <rect x="7" y="32" width="1" height="1" fill={secondColor} />
            ...
            <rect x="7" y="33" width="1" height="1" fill={secondColor} />
            <rect x="5" y="34" width="1" height="1" fill={secondColor} />
            <rect x="6" y="34" width="1" height="1" fill={secondColor} />
            <rect x="5" y="35" width="1" height="1" fill={secondColor} />
        </svg>
    )
}
