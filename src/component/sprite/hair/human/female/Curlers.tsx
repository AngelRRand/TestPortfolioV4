...
const Curlers: React.FC<spriteHair> = ({position, colorPrincipal, colorSecond}) => {
    return (
        <svg version="1.1" className={styles.sprite} viewBox={`${position.x} ${position.y} 128 32`} fill="currentColor"
            ...
            <rect x="82" y="5" width="1" height="1" fill={colorSecond}/>
            ...
            <rect x="50" y="6" width="1" height="1" fill={colorSecond}/>
            ...
            <rect x="114" y="6" width="1" height="1" fill={colorSecond}/>
