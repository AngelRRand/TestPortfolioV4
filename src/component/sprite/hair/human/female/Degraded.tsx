...
const Degraded: React.FC<spriteHair> = ({ position, color, secondColor }) => {
    return (
        <svg version="1.1" className={styles.sprite} viewBox={`${position.x} ${position.y} 128 32`} fill="currentColor" xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges">
            ...
            <rect x="84" y="2" width="1" height="1" fill={color} />
            ...
            <rect x="116" y="3" width="1" height="1" fill={color} />
            ...
            <rect x="11" y="4" width="1" height="1" fill={secondColor} />
            <rect x="12" y="4" width="1" height="1" fill={secondColor} />
            ...
            <rect x="42" y="4" width="1" height="1" fill={color} />
            ...
            <rect x="73" y="4" width="1" height="1" fill={color} />
            <rect x="74" y="4" width="1" height="1" fill={color} />
            <rect x="75" y="4" width="1" height="1" fill={secondColor} />
            <rect x="76" y="4" width="1" height="1" fill={secondColor} />
            ...
            <rect x="106" y="4" width="1" height="1" fill={color} />
            ...
            <rect x="41" y="5" width="1" height="1" fill={color} />
            <rect x="42" y="5" width="1" height="1" fill={color} />
            <rect x="43" y="5" width="1" height="1" fill={secondColor} />
            <rect x="44" y="5" width="1" height="1" fill={secondColor} />
            ...
            <rect x="83" y="5" width="1" height="1" fill={color} />
            ...
            <rect x="105" y="5" width="1" height="1" fill={color} />
            <rect x="106" y="5" width="1" height="1" fill={color} />
            <rect x="107" y="5" width="1" height="1" fill={secondColor} />
            <rect x="108" y="5" width="1" height="1" fill={secondColor} />
            ...
            <rect x="51" y="6" width="1" height="1" fill={color} />
            ...
            <rect x="87" y="6" width="1" height="1" fill={secondColor} />
            ...
            <rect x="115" y="6" width="1" height="1" fill={color} />
            ...
            <rect x="55" y="7" width="1" height="1" fill={secondColor} />
            ...
            <rect x="86" y="7" width="1" height="1" fill={color} />
            <rect x="87" y="7" width="1" height="1" fill="#1A1715" />
            <rect x="88" y="7" width="1" height="1" fill={secondColor} />
            ...
            <rect x="119" y="7" width="1" height="1" fill={secondColor} />
            ...
            <rect x="20" y="8" width="1" height="1" fill={secondColor} />
            ...
            <rect x="54" y="8" width="1" height="1" fill={color} />
            <rect x="55" y="8" width="1" height="1" fill="#1A1715" />
            <rect x="56" y="8" width="1" height="1" fill={secondColor} />
            ...
            <rect x="84" y="8" width="1" height="1" fill={secondColor} />
            <rect x="85" y="8" width="1" height="1" fill={color} />
            ...
            <rect x="118" y="8" width="1" height="1" fill={color} />
            <rect x="119" y="8" width="1" height="1" fill="#1A1715" />
            <rect x="120" y="8" width="1" height="1" fill={secondColor} />
            <rect x="121" y="8" width="1" height="1" fill="#1A1715" />
            <rect x="7" y="9" width="1" height="1" fill="#1A1715" />
            <rect x="8" y="9" width="1" height="1" fill={secondColor} />
            ...
            <rect x="52" y="9" width="1" height="1" fill={secondColor} />
            <rect x="53" y="9" width="1" height="1" fill={color} />
            ...
            <rect x="72" y="9" width="1" height="1" fill={secondColor} />
            ...
            <rect x="85" y="9" width="1" height="1" fill={secondColor} />
            ...
            <rect x="116" y="9" width="1" height="1" fill={secondColor} />
            <rect x="117" y="9" width="1" height="1" fill={color} />
            ...
            <rect x="21" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="40" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="53" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="85" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="104" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="117" y="10" width="1" height="1" fill={secondColor} />
            ...
            <rect x="8" y="11" width="1" height="1" fill={secondColor} />
            ...
            <rect x="53" y="11" width="1" height="1" fill={secondColor} />
            ...
            <rect x="72" y="11" width="1" height="1" fill={secondColor} />
            ...
            <rect x="86" y="11" width="1" height="1" fill={secondColor} />
            ...
            <rect x="117" y="11" width="1" height="1" fill={secondColor} />
            ...
            <rect x="21" y="12" width="1" height="1" fill={secondColor} />
            <rect x="22" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="39" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="40" y="12" width="1" height="1" fill={secondColor} />
            ...
            <rect x="54" y="12" width="1" height="1" fill={secondColor} />
            <rect x="55" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="72" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="73" y="12" width="1" height="1" fill={color} />
            ...
            <rect x="85" y="12" width="1" height="1" fill={secondColor} />
            <rect x="86" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="103" y="12" width="1" height="1" fill="#1A1715" />
            <rect x="104" y="12" width="1" height="1" fill={secondColor} />
            ...
            <rect x="118" y="12" width="1" height="1" fill={secondColor} />
            ...
            <rect x="21" y="13" width="1" height="1" fill={secondColor} />
            <rect x="22" y="13" width="1" height="1" fill="#1A1715" />
            <rect x="40" y="13" width="1" height="1" fill="#1A1715" />
            <rect x="41" y="13" width="1" height="1" fill={color} />
            ...
            <rect x="53" y="13" width="1" height="1" fill={secondColor} />
            ...
            <rect x="85" y="13" width="1" height="1" fill={secondColor} />
            <rect x="86" y="13" width="1" height="1" fill="#1A1715" />
            <rect x="104" y="13" width="1" height="1" fill="#1A1715" />
            <rect x="105" y="13" width="1" height="1" fill={color} />
            ...
            <rect x="117" y="13" width="1" height="1" fill={secondColor} />
            <rect x="118" y="13" width="1" height="1" fill="#1A1715" />
            <rect x="20" y="14" width="1" height="1" fill="#1A1715" />
            <rect x="21" y="14" width="1" height="1" fill={secondColor} />
            ...
            <rect x="53" y="14" width="1" height="1" fill={secondColor} />
            <rect x="54" y="14" width="1" height="1" fill="#1A1715" />
            <rect x="84" y="14" width="1" height="1" fill="#1A1715" />
            <rect x="85" y="14" width="1" height="1" fill={secondColor} />
            ...
            <rect x="117" y="14" width="1" height="1" fill={secondColor} />
            ...
            <rect x="53" y="15" width="1" height="1" fill={secondColor} />
            ...
            <rect x="117" y="15" width="1" height="1" fill={secondColor} />
